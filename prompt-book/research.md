...
| Problem | 36% | 31% | 유지 |
| Implication | 9% | 25% | **핵심 — 4배 더 많이 사용** |
| Need-Payoff | 10% | 19% | **중요 — 2배 더 많이 사용** |

**"Advance" 개념 — 대형 세일즈 각 콜의 목표**

Rackham은 대형 세일즈에서 각 영업 콜의 결과를 세 가지로 구분:
- **Order (수주)**: 최종 계약 성사
- **Advance (전진)**: 다음 구체적 행동 약속 (예: 데모 일정, 의사결정자 미팅 주선) → 성공
- **Continuation (지속)**: "또 연락하겠습니다" 수준 — 진전 없음 → 사실상 실패

**실무 함의**: 각 콜 전에 "이 콜에서 얻을 Advance는 무엇인가?"를 사전에 정의해야 함. Continuation으로 끝나는 콜이 많다면 파이프라인이 실제보다 부풀려져 있는 것.

**SPIN 적용 시 검증된 성과 (Huthwaite Case Studies)**

| 기업 | 결과 | 출처 |
|------|------|------|
| Honeywell | 영업 성공률 **20% 향상** | Huthwaite Case Study |
| IBM | 전환율 **30% 향상** | Huthwaite Case Study |
| Fortune 100 기업 | 전체의 **50%**가 SPIN 훈련 도입 | Huthwaite International |
| SPIN 적용 시 이의 감소율 | **55%** | Huthwaite Research |
...
**채널 갈등 발생 현황 수치 (OroCommerce Research)**

- 채널 관리자 **56%**가 직판팀 vs 외부 채널 파트너 갈등 경험
- 채널 관리자 **53%**가 사내 영업팀 vs 직판 채널 갈등 경험
- 소매업자 **38%**가 채널 갈등을 심각한 비즈니스 문제로 인식
- 그 중 **44%**가 앞으로 더 악화될 것으로 예상
